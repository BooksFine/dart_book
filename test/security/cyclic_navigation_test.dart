...
<ncx xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1">
  <navMap>
    ...
    test(
      'Footnotes: Handles mutual cross-referencing footnotes without infinite loops (fn1 <-> fn2)',
      () async {
...
<FictionBook xmlns="http://www.gribuser.ru/xml/fictionbook/2.0" xmlns:l="http://www.w3.org/1999/xlink">
  ...
  <body name="notes">
    ...
    <section id="fn2">
      <p>Сноска 2 ссылается обратно на <a type="note" l:href="#fn1">сноску 1</a>.</p>
        ...
        final book = Fb2Decoder().decode(
          Uint8List.fromList(utf8.encode(fb2Xml)),
        );
    ...
    test(
      'Footnotes: Handles self-referencing footnote (fn1 -> fn1) and circular chains (fn1 -> fn2 -> fn3 -> fn1)',
      () async {
        const fb2Xml = '''<?xml version="1.0" encoding="UTF-8"?>
<FictionBook xmlns="http://www.gribuser.ru/xml/fictionbook/2.0" xmlns:l="http://www.w3.org/1999/xlink">
  <description>
  ...
  <body name="notes">
    ...
    test(
      'Deeply nested AST sections and quotations (40 levels) normalize and serialize safely',
      () {
        BookBlock currentBlock = const BookParagraph(
          inlines: [BookText('Глубокий текст')],
        );
        for (var i = 0; i < 40; i++) {
