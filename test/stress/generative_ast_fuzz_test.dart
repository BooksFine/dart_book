...
void main() {
  group('Stress: Generative AST Property-Based Fuzzing', () {
    test('50 randomly generated AST books roundtrip through EPUB with AST normalization', () async {
    ...
    test('50 randomly generated AST books roundtrip through FB2 with structure verification', () async {
  ...
  group('Stress: Crash-Free Invariant on Corrupted Byte Streams', () {
    test('50 mutated/corrupted byte streams never cause unhandled TypeError, RangeError, or StackOverflowError', () async {
      final generator = AstGenerator(9999);
      final testLengths = [
        0, 1, 2, 3, 4, 8, 16, 32, 57, 58, 64, 100, 128, 256, 512, 1024, 2048, 4096, 8192, 16384,
      ];
      ...
      for (var i = 0; i < 50; i++) {
        ...
        try {
          ...
          fail('Unhandled TypeError in DartBook.load (EPUB) for length $length: $e');
        } on RangeError catch (e) {
          fail('Unhandled RangeError in DartBook.load (EPUB) for length $length: $e');
        } on StackOverflowError catch (e) {
          fail('Unhandled StackOverflowError in DartBook.load (EPUB) for length $length: $e');
        } catch (_) {
        ...
        try {
          ...
          fail('Unhandled TypeError in DartBook.load (FB2) for length $length: $e');
        } on RangeError catch (e) {
          fail('Unhandled RangeError in DartBook.load (FB2) for length $length: $e');
        } on StackOverflowError catch (e) {
          fail('Unhandled StackOverflowError in DartBook.load (FB2) for length $length: $e');
        } catch (_) {
          // Cleanly caught exception
        }
        ...
        try {
          ...
          fail('Unhandled StackOverflowError in EpubDecoder for length $length: $e');
        } catch (_) {
          // Cleanly caught exception
        }
        ...
        try {
          ...
          fail('Unhandled StackOverflowError in Fb2Decoder for length $length: $e');
        } catch (_) {
          // Cleanly caught exception
        }
        ...
        try {
          ...
          fail('Unhandled RangeError in Fb2ZipDecoder for length $length: $e');
        } on StackOverflowError catch (e) {
          fail('Unhandled StackOverflowError in Fb2ZipDecoder for length $length: $e');
        } catch (_) {
          // Cleanly caught exception
        }
        ...
        try {
          ...
          fail('Unhandled StackOverflowError in HtmlParser for length $length: $e');
        } catch (_) {
          // Cleanly caught exception
        }
        ...
        try {
          ...
          fail('Unhandled StackOverflowError in Fb2Parser for length $length: $e');
        } catch (_) {
          // Cleanly caught exception
        }
        ...
        try {
          ...
          fail('Unhandled TypeError in EpubNavDocument for length $length: $e');
        } on RangeError catch (e) {
          fail('Unhandled RangeError in EpubNavDocument for length $length: $e');
        } on StackOverflowError catch (e) {
          fail('Unhandled StackOverflowError in EpubNavDocument for length $length: $e');
        } catch (_) {
          // Cleanly caught exception
        }
        ...
        try {
          ...
          fail('Unhandled TypeError in EpubNcxDocument for length $length: $e');
        } on RangeError catch (e) {
          fail('Unhandled RangeError in EpubNcxDocument for length $length: $e');
        } on StackOverflowError catch (e) {
          fail('Unhandled StackOverflowError in EpubNcxDocument for length $length: $e');
        } catch (_) {
          // Cleanly caught exception
        }
      }
