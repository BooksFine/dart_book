...
void main() {
  group('Cross-Format Roundtrip & Fixed-Point Idempotence Tests', () {
    test(
      'Chain: EPUB -> Book -> FB2 -> Book -> EPUB with Calibre EPUB sample',
      () async {
    ...
    test(
      'Chain: FB2 -> Book -> EPUB -> Book -> FB2 with LitRes FB2 sample',
      () async {
    ...
    test(
      'Chain: FB2 2.1 Sample -> EPUB -> FB2 -> EPUB -> FB2 (Fixed-Point Idempotence)',
      () async {
    ...
    test(
      'Complex Multi-Format Conversion with AstGenerator generated book',
      () async {
