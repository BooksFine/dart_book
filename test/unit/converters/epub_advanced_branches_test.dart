...
void main() {
  group('EPUB Advanced Branches & Multimedia Codec Tests', () {
    test(
      'EpubEncoder handles Audio, Video, MathML, SVG and Layouts in XHTML and OPF',
      () async {
        ...
        final sec =
            decoded.content.blocks.firstWhere((b) => b is BookSection)
                as BookSection;
    ...
    test(
      'EpubConverter handles fixed-layout and custom naming policies',
      () async {
    ...
    test(
      'EpubConverter & Fb2Converter helper methods work synchronously and asynchronously',
      () async {
        final book = const Book(
          metadata: BookMetadata(
            id: 'helper-book',
