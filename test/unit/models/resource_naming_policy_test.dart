...
void main() {
  group('BookResourceNamingPolicy Tests', () {
    test(
      'PreserveNamingPolicy handles URLs, data URIs and fallback extensions',
      () {
        ...
        expect(
          policy.generateName(
            'https://example.com/cover.jpg?token=123',
            isInline: false,
            index: 1,
          ),
          equals('cover.jpg'),
    ...
    test('HashNamingPolicy generates hash based filenames', () {
      ...
      final name1 = policy.generateName(
        'https://site.com/foo.png',
        isInline: false,
        index: 0,
      );
      final name2 = policy.generateName(
        'https://site.com/foo.png',
        isInline: false,
        index: 1,
      );
      final name3 = policy.generateName(
        'https://site.com/bar.png',
        isInline: false,
        index: 2,
      );
      ...
      expect(
        name1,
        equals(name2),
        reason: 'Identical source should produce identical hash name',
      );
